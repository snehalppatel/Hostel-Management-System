...
<body class="hold-transition register-page" style="background-color: orange;">
<div class="register-box">
    ...
    <div class="card">
        ...
        <div class="card-body register-card-body">
            <p class="login-box-msg">OTP Form</p>
                @include('notification')
            <form method="post" action="{{ route('register') }}">
                @csrf

                <p>Please enter OPT which is send to {{$data['email']}}</p>
            ...
            <input type="hidden" name="password_confirmation" value="{{$data['password_confirmation']}}">                                                                    
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <a href="{{ route('resent-otp',['email' => $data['email']]) }}" class="text-center">Resend OTP</a>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
