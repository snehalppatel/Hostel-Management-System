        ...
        <div class="card-body register-card-body">
            ...
            <form method="post" action="{{ route('register') }}">
                ...
                <div class="input-group mb-3">
                    <label id="student"><input type="radio" name="type" value="Student" checked> Student</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label><input type="radio" name="type" value="Warden" disabled> Warden</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label><input type="radio" name="type" value="Security" disabled> Security</label>                                        
                </div>                
                <div class="input-group mb-3">
                    <input type="text"
                           name="roll_number"
